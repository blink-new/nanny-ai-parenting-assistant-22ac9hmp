        ...
        <View style={styles.quickActions}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <TouchableOpacity 
              ...
              onPress={() => setInputText("Why is my baby crying and how can I calm them?")}
            >
              <Text style={styles.quickActionText}>Baby crying</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={styles.quickActionButton}
              onPress={() => setInputText("How often should my baby be feeding?")}
            >
              <Text style={styles.quickActionText}>Feeding schedule</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={styles.quickActionButton}
              onPress={() => setInputText("Is my baby's sleep pattern normal?")}
            >
              <Text style={styles.quickActionText}>Sleep patterns</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={styles.quickActionButton}
              onPress={() => setInputText("When should I be concerned about my baby's development?")}
            >
